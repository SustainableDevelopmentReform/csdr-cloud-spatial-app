...
//     const response = await client.api.v0.organization.$get(
//       {
//         query: {
//           page: '1',
//           size: '10',
...
//     const response = await client.api.v0.organization.$post(
//       {
//         json: {
//           name: 'test',
//         },
...
//     const getIdResponse = await client.api.v0.organization[':id'].$get(
//       {
//         param: {
...
//     await client.api.v0.organization[':id'].$put(
//       {
//         param: {
//           id: data.id.toString(),
//         },
...
//     await client.api.v0.organization[':id'].$delete(
//       {
//         param: {
//           id: data.id.toString(),
//         },
...
//     const response = await client.api.v0.organization[':id'].$get(
//       {
//         param: {
//           id: '-1',
//         },
...
//     const res = await app.request('/api/v0/organization', {
//       method: 'POST',
//       body: JSON.stringify({
//         foo: 'bar',
//       }),
