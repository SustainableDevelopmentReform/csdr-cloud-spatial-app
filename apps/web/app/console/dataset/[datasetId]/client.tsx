  ...
  const formActions: CrudFormAction[] = useMemo(() => {
    ...
    if (canEdit) {
      actions.push({
        ...
        description:
          'Permanently remove the dataset, including all dependents.',
        buttonVariant: 'destructive',
        buttonTitle: 'Delete',
        mutation: deleteDataset,
        confirmDialog: {
          title: 'Are you sure?',
          description: `This action cannot be undone. This will permanently delete ${dataset?.name ?? 'this'} dataset and remove all dependents.`,
