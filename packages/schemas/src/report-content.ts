...
type ReportChartNodeAttributes = {
...
const reportMarkSchema: z.ZodType<ReportMark> = z
  .object({
    type: z.string(),
...
const reportChartNodeAttributesSchema: z.ZodType<ReportChartNodeAttributes> = z
  .object({
...
const reportContentNodeSchema: z.ZodType<ReportContentNode> = z.lazy(() =>
  z
    .object({
