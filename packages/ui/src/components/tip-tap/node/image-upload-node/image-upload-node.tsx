...
import { CloseIcon } from '@repo/ui/components/tip-tap/icons/close-icon'
import '@repo/ui/components/tip-tap/node/image-upload-node/image-upload-node.scss'
import { focusNextNode, isValidPosition } from '@repo/ui/lib/tiptap-utils'
