...
import {
  ...
  isNodeTypeSelected,
  isValidPosition,
} from '@repo/ui/lib/tiptap-utils'

// --- Icons ---
import { HeadingOneIcon } from '@repo/ui/components/tip-tap/icons/heading-one-icon'
import { HeadingTwoIcon } from '@repo/ui/components/tip-tap/icons/heading-two-icon'
import { HeadingThreeIcon } from '@repo/ui/components/tip-tap/icons/heading-three-icon'
import { HeadingFourIcon } from '@repo/ui/components/tip-tap/icons/heading-four-icon'
import { HeadingFiveIcon } from '@repo/ui/components/tip-tap/icons/heading-five-icon'
import { HeadingSixIcon } from '@repo/ui/components/tip-tap/icons/heading-six-icon'
